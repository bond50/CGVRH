...
const Partners = () => {
    const list = [
        ...
        {name: 'NHIF and community based organizations (CBOs).', src: '/partners/nhif.jpg',website:'http://www.nhif.or.ke/healthinsurance/'},
        ...
        {name: 'Masinde Muliro University Of Science And Technology', src: '/partners/mmust.png',website:'https://www.mmust.ac.ke/'},
