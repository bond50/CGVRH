...
const Goals = () => {
    const list = [
        ...
        {title: 'VCRH first opened its doors to the public in the year 2001 under the the Ministry of Health to serve the population of the former Vihiga District.It has a 164 bed capacity with 108% bed occupancy in 4 wards which include services male and female wards, maternity and pediatric wards. The hospital maternity section has 47 beds and 10 incubators.'},
